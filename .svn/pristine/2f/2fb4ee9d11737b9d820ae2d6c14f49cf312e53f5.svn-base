...
public class Method extends Node {
	...
	/**
	 * Holds the actual quality distribution to send to agents
	 */
	private Distribution qualityDistribution;
	

	/**
	 * Holds the actual duration distribution to send to agents
	 */
