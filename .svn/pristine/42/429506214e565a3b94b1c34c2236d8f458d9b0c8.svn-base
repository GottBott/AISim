...
/**
 * This class represents an UpdateTreeMessage. This message is sent by the
 * simulator to an agent during the simulation. It contains nodes and
 * relationships that have recently become visible to the agent.
 * 
 * @author Mike
 *
 */
public class UpdateTreeMessage extends Message {
	/**
	 ...
	 */
	public UpdateTreeMessage(String destinationName, TaskTree tree) {
		...
		this.messageType = "UpdateTreeMessage";
	...
	public String toJSON() throws JSONException {
		...
		jsonStringer.value("UpdateTreeMessage");
