...
public class NewNodeMessage extends Message{
	...
	private void nodeToJSON(Node node, JSONStringer jsonStringer) {
	...
	private void relationshipsToJSON(ArrayList<NodeRelationship> relationships, JSONStringer jsonStringer) {
		jsonStringer.array();
