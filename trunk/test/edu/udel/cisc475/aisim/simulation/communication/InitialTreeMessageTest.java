...
public class InitialTreeMessageTest {
	Task task1;
	Task task2;
	Task task3;
	Method method1;
	...
	public static void main(String args[]) {
		org.junit.runner.JUnitCore.main("InitialTreeMessageTest");
    }
	...
	public void testToJSON() {
		InitialTreeMessage message = new InitialTreeMessage("A1", tree);
		...
		Assert.assertEquals("InitialTreeMessage", messageType);
