...
public class InputParserTest {
	...
	public void basicConstructorTest() throws InvalidFileException {
		InputParser inPa = new InputParser("trunk/testdata/aisim/input/simpleCtaems.txt",seed);
	...
	public void testErrors() throws InvalidFileException{
		InputParser inPa = new InputParser("trunk/testdata/aisim/input/errorCtaems.txt",seed);
		inPa.parse();
	...
	public void testNewtaems() throws InvalidFileException {
		InputParser inPa = new InputParser("trunk/testdata/aisim/input/newtaemsTest.txt",seed);
		inPa.parse();
		InputData id = inPa.getInputData();
